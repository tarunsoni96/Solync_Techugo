    ...
    fetch("http://13.232.62.239:6565/api/user/home", {
      ...
      .then(responseJson => {
        ...
        if (responseJson.statusCode == 200) {
          ...
          // this.props.navigation.navigate('NoConcert',{'sub_ids':params.data,'artist':params.artFest,'loc':""})
        }
        return responseJson;
      })
      .catch(error => {
    ...
    return (
      ...
      >
        <ScrollView stle={{ flex: 1 }} showsVerticalScrollIndicator={false}>
          ...
          resizeMode={'contain'}>
           <Image source={require('../../assets/Images/@BG-gradient.png')} style={{height:'100%',borderRadius:20,width:'100%'}}/> 
            </ImageBackground> */}
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {/* <View style={{width:width/4.6,height:25,backgroundColor:'transparent',alignSelf:'flex-start',justifyContent:'center'}}>
<View style={{height:'100%',width:'80%',backgroundColor:'transparent',borderColor:'#c8aecb',borderWidth:2,borderRadius:4,justifyContent:'center'}}>
<Text style={{color:'#781773',fontSize:15,fontFamily: 'Montserrat-Bold',alignSelf:'center'}}>Rock</Text> 
</View>

</View>
<View style={{width:width/5,height:25,backgroundColor:'transparent',alignSelf:'center'}}>
<View style={{height:'100%',width:'80%',backgroundColor:'transparent',borderColor:'#c8aecb',borderWidth:2,borderRadius:4}}>
<Text style={{color:'#781773',fontSize:15,fontFamily: 'Montserrat-Bold',alignSelf:'center'}}>Pop</Text> 
</View>

</View>
<View style={{width:width/6,height:25,backgroundColor:'transparent',alignSelf:'center'}}>
<View style={{height:'100%',width:'80%',backgroundColor:'transparent',borderColor:'#c8aecb',borderWidth:2,borderRadius:4}}>
<Text style={{color:'#781773',fontSize:15,fontFamily: 'Montserrat-Bold',alignSelf:'center'}}>R&B</Text> 
</View>
...
<View style={{width:'100%'}} >
              <GradButton 
                onPress={() => this.props.navigation.navigate('Settings',{filterType:'Travel'})} 
                ...
                onPress={() =>
                  this.props.navigation.navigate("MultipleView", {
                   ...
                   text='Change travel preferences' />
              </View>
